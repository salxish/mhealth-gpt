# mhealth-gpt
A Python project using the Hugging Face Trainer API to fine-tune DistilGPT2 on specialized medical health (mhealth) datasets for domain-specific text generation.
>"AI can be used for good, not just evil."
>
### ⭐ Project Motivation
 ...
 **reminder**  
 ...
 Direct copies **with or without credit** are forbidden in the following aspects:
  - distribution, sublicensing, or the sale of copies of the software or modified versions of it.
